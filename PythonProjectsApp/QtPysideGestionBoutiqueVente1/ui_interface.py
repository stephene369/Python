...
################################################################################
## Form generated from reading UI file 'interfaceStEKTE.ui'
##
...
"}")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(-1, 0, 526, 904))
...
"}\n"
"QPushButton:focus{\n"
"	border-left : 1px solid #05258f;\n"
"	border-right : 1px solid #05258f;\n"
...
"")
        ...
        self.listeAchat = QTableWidget(self.frame_6)
        if (self.listeAchat.columnCount() < 3):
            self.listeAchat.setColumnCount(3)
        __qtablewidgetitem = QTableWidgetItem()
        self.listeAchat.setHorizontalHeaderItem(0, __qtablewidgetitem)
        __qtablewidgetitem1 = QTableWidgetItem()
        self.listeAchat.setHorizontalHeaderItem(1, __qtablewidgetitem1)
        __qtablewidgetitem2 = QTableWidgetItem()
        self.listeAchat.setHorizontalHeaderItem(2, __qtablewidgetitem2)
        self.listeAchat.setObjectName(u"listeAchat")

        self.verticalLayout_19.addWidget(self.listeAchat)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 538, 535))
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem = self.listeAchat.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("MainWindow", u"Article", None));
        ___qtablewidgetitem1 = self.listeAchat.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", u"Prix", None));
        ___qtablewidgetitem2 = self.listeAchat.horizontalHeaderItem(2)
