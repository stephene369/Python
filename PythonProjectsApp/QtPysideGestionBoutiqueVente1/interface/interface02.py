...
################################################################################
## Form generated from reading UI file 'interfacexfKONA.ui'
##
...
"")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 1442, 889))
...
"")
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QRect(0, 0, 1455, 775))
...
"	border-bottom : 1px solid #1c3d70;}")
        ...
        self.tablePage.setStyleSheet(u"QPushButton,QComboBox {\n"
"	background-color : ;\n"
"	color : #fff ;\n"
"	border-radius : 7px ;\n"
"	border-left : 1px solid #1e4b87;\n"
...
"	margin-top : 10 px ;\n"
"}\n"
"QPushButton:pressed , QTableWidget:pressed,QComboBox:pressed{\n"
"	background-color: #a7a7a7;\n"
"}\n"
"\n"
"QPushButton:hover  , QTableWidget:hover,QComboBox:hover{\n"
"	border-left : 2px solid #1c3d70;\n"
"	border-right : 2px solid #1c3d70;\n"
"	border-bottom : 2px solid #1c3d70;\n"
"}\n"
"QPushButton:focus , QTableWidget:focus , QComboBox:focus{\n"
"	border-left : 2px solid #1c3d70;\n"
"	border-right : 2px solid #1c3d70;\n"
"	border-top : 2px solid #1c3d70;\n"
"	border-bottom : 2px solid #1c3d70 ;\n"
...
"	border-bottom : 1px solid #1c3d70;}")
        ...
        self.verticalLayout_34 = QVBoxLayout(self.dbPageInfo)
        self.verticalLayout_34.setObjectName(u"verticalLayout_34")
        self.frame_11 = QFrame(self.dbPageInfo)
        ...
        self.usersCombo = QComboBox(self.frame_11)
        self.usersCombo.setObjectName(u"usersCombo")

        self.horizontalLayout_9.addWidget(self.usersCombo)

        self.dateCombo = QComboBox(self.frame_11)
        self.dateCombo.setObjectName(u"dateCombo")

        self.horizontalLayout_9.addWidget(self.dateCombo)

        self.displayMoreInfoBtn = QPushButton(self.frame_11)
        self.displayMoreInfoBtn.setObjectName(u"displayMoreInfoBtn")

        self.horizontalLayout_9.addWidget(self.displayMoreInfoBtn)

        self.fiterInfoTableBtn = QPushButton(self.frame_11)
        self.fiterInfoTableBtn.setObjectName(u"fiterInfoTableBtn")

        self.horizontalLayout_9.addWidget(self.fiterInfoTableBtn)
        ...
        self.verticalLayout_34.addWidget(self.frame_11, 0, Qt.AlignTop)

        self.frame_10 = QFrame(self.dbPageInfo)
        ...
        self.moreInfoTable = QTableWidget(self.frame_10)
        self.moreInfoTable.setObjectName(u"moreInfoTable")
        self.moreInfoTable.setStyleSheet(u"QHeaderView{ \n"
"	background-color: #000000 ; color: black; \n"
"} \n"
"\n"
":hover{\n"
...
"	border-bottom : 1px solid #1c3d70;}")
        ...
        self.verticalLayout_35.addWidget(self.moreInfoTable)

        self.moreInfoLab = QLabel(self.frame_10)
        self.moreInfoLab.setObjectName(u"moreInfoLab")

        self.verticalLayout_35.addWidget(self.moreInfoLab)


        self.verticalLayout_34.addWidget(self.frame_10)

        self.backToTableBtn = QPushButton(self.dbPageInfo)
        self.backToTableBtn.setObjectName(u"backToTableBtn")

        self.verticalLayout_34.addWidget(self.backToTableBtn)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.moreInfos.setText(QCoreApplication.translate("MainWindow", u"PLus d Information", None))
        self.label_35.setText(QCoreApplication.translate("MainWindow", u"Nom d'utilisateur / Date :", None))
        self.displayMoreInfoBtn.setText(QCoreApplication.translate("MainWindow", u"Afficher ", None))
        self.fiterInfoTableBtn.setText(QCoreApplication.translate("MainWindow", u"  Filtrer  ", None))
        self.moreInfoLab.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.backToTableBtn.setText(QCoreApplication.translate("MainWindow", u"Retour", None))
