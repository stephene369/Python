...
class Send :
    ...
    def add_file(self) :
        self.addiFilesPath,_ = self.dialog.getOpenFileNames(None,'Tous type de fichiers Text',".")
        self.addFilenames = [ Path(file).name for file in self.addiFilesPath ]

        self.filenames = self.filenames+self.addFilenames
        self.filesPath = self.filesPath+self.addiFilesPath
