...
## FILE SHARE SERVER 
from .fileshareserver import ServerWidget 

## CV builder 
from .cvbuilder import CvBuilderWidget 
...
class Window(FluentWindow):
    ...
    def __init__(self):
        ...
        ## SERVER 
        self.serverInterface = ServerWidget("File Share" , self) 

        ## CV
        self.cvBuilderInterface = CvBuilderWidget("CvBuilder" , self)
    ...
    def initNavigation(self):
        self.addSubInterface(self.homeInterface, FIF.LANGUAGE, 'Offline Translator')
        self.addSubInterface(self.packInterface, FIF.LIBRARY, 'Packages')

        self.navigationInterface.addSeparator()
        self.addSubInterface(self.serverInterface , FIF.CONNECT, "File Server")
        
        self.navigationInterface.addSeparator()
        self.addSubInterface(self.cvBuilderInterface, FIF.STOP_WATCH,"Cv Builder")
