...
class HomeWidget(SmoothScrollArea):
    ...
    def __init__(self, text: str, parent=None):
        ...
        self.frame0 = QFrame(self.Frame)
        self.frame0_box = QHBoxLayout(self.frame0)

        self.Title = TitleLabel("Offline Translate", self.Frame)
        self.frame0_box.addWidget(self.Title , 0 , Qt.AlignmentFlag.AlignTop)
    ...
    def initHomeInterface(self) : 
        ...
        self.Vbox.addWidget(self.frame0, 0 , Qt.AlignmentFlag.AlignTop)
